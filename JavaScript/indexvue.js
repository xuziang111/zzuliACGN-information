let index = Vue.component('index',{
    ...
    <div>
        <div class="left-side">
            <div>
                <div class="block" id="top-carousel">
                    <el-carousel height="210px" arrow="never">
                        <el-carousel-item v-for="(item,index) in index.indeximg" :key="index">
            ...
            <div class="article-content">
                <section class="article" v-for="(item,index) in index.article">
                <a :href="item.href">
    ...
    created:function(){
        if(this.ifcreated.index === 0){
            ...
            this.$emit('loadindearticle',{page:'index',part:'article'})
        }
    }
})